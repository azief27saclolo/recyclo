        ...
        <section class="section orders" aria-label="orders" data-section>
            <div class="container">
                ...
                <div class="order-tabs" style="display: flex; overflow-x: auto; gap: 10px; margin-bottom: 30px; padding-bottom: 5px;">
                    <button class="tab-btn active" data-tab="new" style="background: #517a5b; color: white; border: none; padding: 10px 20px; border-radius: 8px; display: flex; align-items: center; white-space: nowrap; cursor: pointer;">
                ...
                <div class="order-cards" id="new-orders" style="display: flex; flex-direction: column; gap: 20px;">
                    ...
                    @else
                        <div style="grid-column: 1 / -1; text-align: center; padding: 50px;">
                            ...
                            <p style="font-size: 18px; color: #666; margin-top: 10px;">No new orders</p>
                ...
                <div class="order-cards" id="to-ship-orders" style="display: none; flex-direction: column; gap: 20px;">
                    ...
                    @else
                        <div style="grid-column: 1 / -1; text-align: center; padding: 50px;">
                            ...
                            <p style="font-size: 18px; color: #666; margin-top: 10px;">No orders to ship</p>
                        </div>
                    @endif
                </div>
